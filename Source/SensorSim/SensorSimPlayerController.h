...
#include "SensorSimPlayerController.generated.h"

class UInputMappingContext;
class ASensorSimPawn;
class USensorSimUI;
 ...
 */
UCLASS(abstract)
class SENSORSIM_API ASensorSimPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<ASensorSimPawn> VehiclePawn;
