...
ASensorSimOffroadCar::ASensorSimOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = USensorSimOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = USensorSimOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = USensorSimOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = USensorSimOffroadWheelRear::StaticClass();
