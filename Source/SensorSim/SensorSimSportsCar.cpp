...
ASensorSimSportsCar::ASensorSimSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = USensorSimSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = USensorSimSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = USensorSimSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = USensorSimSportsWheelRear::StaticClass();
